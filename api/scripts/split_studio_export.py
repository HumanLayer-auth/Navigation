...
building_footprint_local_m을 **source 좌표**로 저장한다. 여기서
coordinate_system.affine_transforms.source_to_local_m으로 실제 local_m으로 변환한다.

실행 (api/ 디렉토리에서):
  python -m scripts.split_studio_export <통합export.json>
  python -m scripts.split_studio_export <통합export.json> --floor 1f --out-dir app/data/studio/thehyundai-seoul
"""
...
DEFAULT_OUT_DIR = API_ROOT / "app" / "data" / "studio" / "thehyundai-seoul"
