...
기존 추출 산출물인 `thehyundai_indoor_navigation_dataset/thehyundai_building.geojson`,
`thehyundai_indoor_navigation_dataset/thehyundai_building_summary.json`,
`thehyundai_indoor_navigation_dataset/floor_assets/`를 입력으로 사용해
...
- `thehyundai_indoor_navigation_dataset/floor_assets/json/map-*.json`
...
- `thehyundai_indoor_navigation_dataset/navigation_map.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/building.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/nodes.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/edges.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/stores.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/pois.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/ocr_results.json`
- `thehyundai_indoor_navigation_dataset/navigation_map_parts/image_analysis.json`
- `thehyundai_indoor_navigation_dataset/preview.html`
- `thehyundai_indoor_navigation_dataset/debug/corridors.png`
- `thehyundai_indoor_navigation_dataset/debug/navigation_graph.png`
- `thehyundai_indoor_navigation_dataset/debug/ocr_result.png`
- `thehyundai_indoor_navigation_dataset/debug/stores.png`
- `thehyundai_indoor_navigation_dataset/debug/final_navigation_map.png`

## 구조

`navigation_map.json`은 이제 큰 데이터를 직접 담지 않고 split manifest 역할만 한다. 실제 데이터는
`thehyundai_indoor_navigation_dataset/navigation_map_parts/`에 분리 저장된다.
...
표시한다. 정합 품질은 `thehyundai_indoor_navigation_dataset/debug/calibration.png`와 `navigation_map.json`의
